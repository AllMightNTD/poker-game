...
CREATE TABLE public.glue_user_info (
    ...
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
...
CREATE TABLE point_dev_test.aml_same_email_prefix_daily_detection_jst (
    id bigint DEFAULT "identity"(738390, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE point_dev_test.aml_same_email_prefix_daily_detection_user (
    id bigint DEFAULT "identity"(738397, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE point_dev_test.pos_best_price (
    id bigint DEFAULT default_identity(478955, 0, ('1,1'::character varying)::text) NOT NULL,
    symbol_id bigint NOT NULL,
    best_ask numeric(34,20) NOT NULL,
    best_bid numeric(34,20) NOT NULL,
    created_at timestamp without time zone DEFAULT ('now'::character varying)::timestamp with time zone NOT NULL,
    updated_at timestamp without time zone
);
...
CREATE TABLE point_dev_test.waf_blocked_access (
    id bigint DEFAULT "identity"(675048, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.aml_multi_bank_account_fiat_tx_user (
    id bigint DEFAULT "identity"(836815, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_aml_high_frequency_fiat_tx_user (
    ...
    detected_at timestamp without time zone NOT NULL,
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
    updated_at timestamp without time zone DEFAULT getdate() NOT NULL
);
...
CREATE TABLE public.glue_asset (
    id bigint DEFAULT "identity"(817030, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_asset_summary (
    id bigint DEFAULT "identity"(817034, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    currency character varying(128) NOT NULL,
...
CREATE TABLE public.glue_asset_transfer (
    id bigint DEFAULT "identity"(817077, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_choice_p_withdrawal (
    ...
    withdraw_time timestamp without time zone DEFAULT getdate(),
...
CREATE TABLE public.glue_currency_config (
    id bigint DEFAULT "identity"(817231, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_currency_pair_config (
    id bigint DEFAULT "identity"(817239, 0, '1,1'::text) NOT NULL,
    trade_type character varying(128) NOT NULL,
...
CREATE TABLE public.glue_deposit (
    id bigint DEFAULT "identity"(817081, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    currency character varying(128) NOT NULL,
...
CREATE TABLE public.glue_deposit_account (
    id bigint DEFAULT "identity"(817120, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    currency character varying(128) NOT NULL,
    address character varying(255) NOT NULL,
...
CREATE TABLE public.glue_excessive_deposit_user_by_one_time (
    id bigint DEFAULT "identity"(817348, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    email character varying(255) NOT NULL,
...
CREATE TABLE public.glue_excessive_deposit_user_by_period (
    id bigint DEFAULT "identity"(817343, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    email character varying(255) NOT NULL,
    amount numeric(34,20) NOT NULL,
...
CREATE TABLE public.glue_exchange_and_invest_asset_summary (
    id bigint DEFAULT "identity"(817172, 0, '1,1'::text) NOT NULL,
    user_id bigint,
...
CREATE TABLE public.glue_point_asset (
    id bigint DEFAULT "identity"(817175, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    currency character varying(128) NOT NULL,
    onhand_amount numeric(34,20) NOT NULL,
    locked_amount numeric(34,20) NOT NULL,
...
CREATE TABLE public.glue_point_partner (
    id bigint DEFAULT "identity"(817377, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_user_antisocial_check (
    id bigint DEFAULT "identity"(817396, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_user_authority (
    id bigint DEFAULT "identity"(817369, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_user_kyc (
    id bigint DEFAULT "identity"(817382, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_user_mail_config (
    id bigint DEFAULT "identity"(817390, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_exchange_summary (
    id bigint DEFAULT "identity"(817128, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    currency character varying(128) NOT NULL,
    current_amount numeric(34,20) DEFAULT 0.00000000000000000000 NOT NULL,
    jpy_conversion numeric(34,20) DEFAULT 0.00000000000000000000 NOT NULL,
...
CREATE TABLE public.glue_fiat_withdrawal_audit (
    id bigint DEFAULT "identity"(817103, 0, '1,1'::text) NOT NULL,
    fiat_withdrawal_id bigint NOT NULL,
...
CREATE TABLE public.glue_financial_assets_deviation_user (
    id bigint DEFAULT "identity"(817294, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_frequent_crypto_deposit_user (
    id bigint DEFAULT "identity"(817299, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_high_value_trader (
    id bigint DEFAULT "identity"(817304, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    trade_type character varying(255) DEFAULT 'SPOT'::character varying,
...
CREATE TABLE public.glue_ieo_details (
    id bigint DEFAULT "identity"(817353, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_ieo_recruit_info (
    id bigint DEFAULT "identity"(817361, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_ieo_user_elect_info (
    id bigint DEFAULT "identity"(817357, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    ieo_recruit_info_id bigint NOT NULL,
...
CREATE TABLE public.glue_investment_purpose_deviation_user (
    id bigint DEFAULT "identity"(817309, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    trade_type character varying(255) DEFAULT 'SPOT'::character varying,
...
CREATE TABLE public.glue_multi_private_wallet_withdrawal_user (
    id bigint DEFAULT "identity"(817314, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    tms_status character varying(255) NOT NULL,
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
...
CREATE TABLE public.glue_paypay_deposit (
    id bigint DEFAULT "identity"(817108, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_point_asset_summary (
    id bigint DEFAULT "identity"(817179, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    currency character varying(128) NOT NULL,
    current_amount numeric(34,20) DEFAULT 0.00000000000000000000 NOT NULL,
...
CREATE TABLE public.glue_point_transfer (
    id bigint DEFAULT "identity"(817214, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    partner_id bigint NOT NULL,
    ...
    transfer_time timestamp without time zone DEFAULT getdate(),
...
CREATE TABLE public.glue_point_user_summary (
    id bigint DEFAULT "identity"(817219, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone,
...
CREATE TABLE public.glue_quick_crypto_to_jpy_user (
    id bigint DEFAULT "identity"(817319, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    tms_status character varying(255) NOT NULL,
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
...
CREATE TABLE public.glue_quick_crypto_transfer_user (
    id bigint DEFAULT "identity"(817324, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    tms_status character varying(255) NOT NULL,
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
...
CREATE TABLE public.glue_same_ip_user (
    id bigint DEFAULT "identity"(817329, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.glue_staking_apply_detail (
    id bigint DEFAULT "identity"(817260, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    staking_info_id bigint NOT NULL,
    currency character varying(255) NOT NULL,
    apply_date timestamp without time zone DEFAULT getdate() NOT NULL,
    ...
    reward_start_date timestamp without time zone DEFAULT getdate() NOT NULL,
    expiration_date timestamp without time zone DEFAULT getdate() NOT NULL,
    cancel_apply_date timestamp without time zone DEFAULT getdate(),
    cancel_date timestamp without time zone DEFAULT getdate(),
    ...
    amount_to_account_date timestamp without time zone DEFAULT getdate(),
...
CREATE TABLE public.glue_symbol (
    id bigint DEFAULT "identity"(817226, 0, '1,1'::text) NOT NULL,
    trade_type character varying(128) NOT NULL,
    currency_pair character varying(128) NOT NULL,
    visible boolean DEFAULT true NOT NULL,
    created_at timestamp without time zone DEFAULT getdate() NOT NULL,
...
CREATE TABLE public.glue_system_config (
    id bigint DEFAULT "identity"(817256, 0, '1,1'::text) NOT NULL,
    currency character varying(128),
...
CREATE TABLE public.glue_uneconomical_crypto_deposit_user (
    id bigint DEFAULT "identity"(817334, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone DEFAULT getdate() NOT NULL,
    user_id bigint NOT NULL,
    email character varying(255) NOT NULL,
    deposit_count integer NOT NULL,
...
CREATE TABLE public.glue_user_info_corporate_agent (
    id bigint DEFAULT "identity"(817274, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    first_name character varying(255) NOT NULL,
    last_name character varying(255) NOT NULL,
    first_kana character varying(255) NOT NULL,
...
CREATE TABLE public.glue_user_info_corporate_owner (
    id bigint DEFAULT "identity"(817278, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    first_name character varying(255) NOT NULL,
    last_name character varying(255) NOT NULL,
    first_kana character varying(255) NOT NULL,
...
CREATE TABLE public.glue_user_info_corporate_representative (
    id bigint DEFAULT "identity"(817270, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    first_name character varying(255) NOT NULL,
    last_name character varying(255) NOT NULL,
    first_kana character varying(255) NOT NULL,
...
CREATE TABLE public.glue_user_login_info (
    id bigint DEFAULT "identity"(817282, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
...
CREATE TABLE public.glue_user_summary (
    id bigint DEFAULT "identity"(817287, 0, '1,1'::text) NOT NULL,
    target_at timestamp without time zone,
    users integer NOT NULL,
...
CREATE TABLE public.glue_wash_trader (
    id bigint DEFAULT "identity"(817339, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    trades integer NOT NULL,
...
CREATE TABLE public.glue_withdrawal (
    id bigint DEFAULT "identity"(817088, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    currency character varying(128) NOT NULL,
...
CREATE TABLE public.glue_withdrawal_account (
    id bigint DEFAULT "identity"(817124, 0, '1,1'::text) NOT NULL,
    user_id bigint NOT NULL,
    currency character varying(128) NOT NULL,
...
CREATE TABLE public.glue_withdrawal_audit (
    id bigint DEFAULT "identity"(817097, 0, '1,1'::text) NOT NULL,
...
CREATE TABLE public.pos_best_price (
    id bigint DEFAULT default_identity(304682, 0, '1,1'::text) NOT NULL,
    symbol_id bigint NOT NULL,
    best_ask numeric(34,20) NOT NULL,
    best_bid numeric(34,20) NOT NULL,
    created_at timestamp without time zone DEFAULT ('now'::text)::timestamp with time zone NOT NULL,
...
CREATE TABLE public.waf_blocked_access (
    id bigint DEFAULT "identity"(675041, 0, '1,1'::text) NOT NULL,
    client_ip character varying(45) NOT NULL,
    country character varying(10) NOT NULL,
    blocked_by_rule character varying(100) NOT NULL,
    request_uri character varying(2048),
