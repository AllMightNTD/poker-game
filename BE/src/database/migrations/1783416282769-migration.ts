...
export class Migration1783416282769 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`audit_logs\` ADD \`userId\` varchar(36) NULL`);
        await queryRunner.query(`ALTER TABLE \`audit_logs\` ADD \`roomId\` bigint NULL`);
        await queryRunner.query(`ALTER TABLE \`audit_logs\` ADD \`actorId\` varchar(36) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`audit_logs\` ADD CONSTRAINT \`FK_3c868775b83bc1eaa72de9251a6\` FOREIGN KEY (\`roomId\`) REFERENCES \`tables\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`audit_logs\` DROP FOREIGN KEY \`FK_2dc33f7f3c22e2e7badafca1d12\``);
        await queryRunner.query(`ALTER TABLE \`audit_logs\` DROP FOREIGN KEY \`FK_3c868775b83bc1eaa72de9251a6\``);
        ...
        await queryRunner.query(`ALTER TABLE \`audit_logs\` DROP COLUMN \`roomId\``);
