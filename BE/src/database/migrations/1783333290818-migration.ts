...
export class Migration1783333290818 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_ee43923e8ce21dbe10bccaba85\` ON \`admin_audit_logs\``);
        await queryRunner.query(`DROP INDEX \`IDX_5d49c245604bbfa780a30ae97d\` ON \`admin_audit_logs\``);
        await queryRunner.query(`DROP INDEX \`IDX_01a78e07962ed72eaf9ccae990\` ON \`admin_audit_logs\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_450a5294dfde65588ff285fcff\` ON \`transactions\``);
