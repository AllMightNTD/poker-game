...
export enum BLogCategory {
  POKER_NEWS = 'POKER_NEWS',
  POKER_TIPS = 'POKER_TIPS',
  POKER_STRATEGIES = 'POKER_STRATEGIES',
  POKER_TOURNAMENTS = 'POKER_TOURNAMENTS',
  POKER_REVIEWS = 'POKER_REVIEWS',
  POKER_INTERVIEWS = 'POKER_INTERVIEWS',
  POKER_OTHER = 'POKER_OTHER',
}
