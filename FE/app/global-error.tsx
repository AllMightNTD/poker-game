  ...
  return (
    <html>
      <body className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 text-center font-sans">
        <h2 className="text-3xl font-extrabold mb-4">Đã xảy ra lỗi hệ thống!</h2>
        <p className="text-slate-400 mb-6 max-w-md">Chúng tôi đang khắc phục sự cố. Vui lòng thử lại sau.</p>
        <button
          onClick={() => reset()}
