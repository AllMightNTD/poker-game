...
export const TableBackground = () => {
  ...
  return (
    <>
      {/* Base gradient */}
      <div
        className={`absolute inset-0 bg-gradient-to-b ${tint} z-0 pointer-events-none transition-colors duration-700`}
      />
      {/* Radial glow at center */}
      <div
        className="absolute inset-0 bg-[radial-gradient(ellipse_50%_40%_at_50%_45%,rgba(0,0,0,0)_0%,rgba(0,0,0,0.4)_100%)] z-0 pointer-events-none"
      />
